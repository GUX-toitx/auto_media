...
// Có đang gắn với 1 dự án không. news_pipeline dùng để BỎ ghi log khi chạy tay (scripts/test_news.mjs),
// tránh đổ rác vào file log dùng chung logs/crawl_*_<ngày>.log.
export function hasLogProject() { return !!currentProject; }
